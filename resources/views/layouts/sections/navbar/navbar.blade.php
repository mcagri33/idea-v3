                ...
                <li class="dropdown-menu-header border-bottom">
                  <div class="dropdown-header d-flex align-items-center py-3">
                    ...
                    <div class="d-flex align-items-center h6 mb-0">
                      <span class="badge bg-label-primary me-2">{{ auth()->user()->unreadNotifications->count() }} Yeni</span>
                      ...
                      <li class="list-group-item list-group-item-action dropdown-notifications-item">
                        <div class="d-flex">
                          ...
                          <div class="flex-grow-1">
                            @if ($notification->type === 'App\Notifications\DocumentStatusChanged')
                              <h6 class="small mb-1">Evrak Durumu Güncellendi</h6>
                              <small class="mb-1 d-block text-body">
                                Evrak: {{ $notification->data['document_name'] }} <br> Durum: {{ $notification->data['status'] }}
                              </small>
                            @elseif ($notification->type === 'App\Notifications\DocumentAddedNotification')
                              <h6 class="small mb-1">Yeni Evrak Yüklendi</h6>
                              <small class="mb-1 d-block text-body">Yeni Evrak: {{ $notification->data['file_name'] }}</small>
                            @endif
                          </div>
                ...
                <li>
                  <div class="d-grid px-2 pt-2 pb-1">
                    <a class="btn btn-sm btn-danger d-flex" href="{{ Route::has('login') ? route('login') : url('auth/login-basic') }}">
                      <small class="align-middle">Giriş Yap</small>
